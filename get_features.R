...
get_features <- function(df, 
  ...
  no_of_words <- str_count(as.character(df$whole_title_sans_edition), " ")
  ...
  no_of_words_title_only <- str_count(as.character(df$whole_title_sans_edition), " ")
  ...
  no_of_words_remainder <- str_count(as.character(df$title_remainder), " ")
